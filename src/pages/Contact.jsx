...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        alert("Something went wrong. Please WhatsApp us or email support.clicksnads@gmail.com directly.");
      }
    } catch (err) {
      alert("Network error. Please WhatsApp us or email support.clicksnads@gmail.com directly.");
    }
  };
  ...
  <script type="application/ld+json">{jsonLdScript(faqSchema(FAQS))}</script>
        ...
        <div style={{ maxWidth: 1320, margin: "0 auto" }}>
          <div ref={ref1} className="cw-grid-2" style={{ gap: 60, alignItems: "end" }}>
            ...
            <div style={{ paddingBottom: 80, opacity: v1 ? 1 : 0, transform: v1 ? "none" : "translateY(30px)", transition: "all .8s cubic-bezier(.16,1,.3,1)" }}>
              <p style={{ fontSize: 12, fontWeight: 700, letterSpacing: "0.18em", color: "#C1502E", textTransform: "uppercase", marginBottom: 24 }}>Get In Touch</p>
              <h1 style={{ fontSize: "clamp(40px,5vw,72px)", fontWeight: 800, color: "#141210", lineHeight: 1.05, letterSpacing: "-2px", marginBottom: 28 }}>
                Let's Build<br />
                Something<br />
                <span style={{ color: "#C1502E", fontStyle: "italic" }}>Extraordinary.</span>
              </h1>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                {[
                  { label: "Email us", value: "support.clicksnads@gmail.com", href: "mailto:support.clicksnads@gmail.com", color: "#C1502E" },
                  { label: "Call us", value: "+91 91371 30817", href: "tel:+919137130817", color: "#141210" },
                  { label: "WhatsApp", value: "Chat with us instantly", href: "https://wa.me/919137130817", color: "#25D366" },
                ].map((item, i) => (
                  <a
                    key={i}
                    href={item.href}
                    ...
                    onMouseLeave={(e) => { e.currentTarget.querySelector(".contact-val").style.color = "#141210"; }}
                  >
                    ...
                    <div>
                      ...
                      <p className="contact-val" style={{ fontSize: 16, fontWeight: 700, color: "#141210", transition: "color .25s" }}>{item.value}</p>
                    </div>
                  </a>
                ))}
              </div>
          ...
          <div ref={ref2} className="cw-grid-2" style={{ gap: 60, alignItems: "start" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16, opacity: v2 ? 1 : 0, transform: v2 ? "none" : "translateX(-24px)", transition: "all .8s cubic-bezier(.16,1,.3,1)" }}>
              ...
              <div className="cw-grid-2" style={{ gap: 16 }}>
                ...
                {/* Stats card */}
                <div style={{ borderRadius: 16, background: "#C1502E", padding: "32px 24px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
              ...
              <div style={{ background: "#fff", borderRadius: 16, padding: "32px 28px", border: "1px solid #E4E3DD" }}>
                <h3 style={{ fontSize: 16, fontWeight: 800, color: "#141210", marginBottom: 20 }}>Why work with us?</h3>
                {[
                  ...
                  <div key={i} style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 14 }}>
                    <div style={{ width: 20, height: 20, borderRadius: "50%", background: "rgba(193,80,46,.1)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                      <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#C1502E" strokeWidth="3"><polyline points="20 6 9 17 4 12"/></svg>
                    </div>
            ...
            <div style={{ opacity: v2 ? 1 : 0, transform: v2 ? "none" : "translateY(24px)", transition: "all .8s cubic-bezier(.16,1,.3,1) .1s" }}>
              <div style={{ background: "#fff", borderRadius: 20, padding: "48px 40px", boxShadow: "0 4px 6px rgba(0,0,0,.04), 0 24px 80px rgba(0,0,0,.08)" }}>
                <h2 style={{ fontSize: "clamp(24px,2.5vw,32px)", fontWeight: 800, color: "#141210", marginBottom: 8, letterSpacing: "-0.8px" }}>
                ...
                <form onSubmit={handleSubmit}>
                  {[
                    ...
                    <div key={i} style={{ marginBottom: 20 }}>
                      <label style={{ fontSize: 12, fontWeight: 700, color: "#141210", display: "block", marginBottom: 8, letterSpacing: "0.02em" }}>{field.label}</label>
                      <input
                        type={field.type}
                        value={field.value}
                        ...
                        onFocus={(e) => { e.target.style.borderColor = "#C1502E"; e.target.style.background = "#fff"; e.target.style.boxShadow = "0 0 0 3px rgba(193,80,46,.08)"; }}
                  ...
                  <div style={{ marginBottom: 28 }}>
                    <label style={{ fontSize: 12, fontWeight: 700, color: "#141210", display: "block", marginBottom: 8 }}>Tell us about your project *</label>
                    <textarea
                      value={message}
                  ...
                  <button
                    ...
                    style={{
                      width: "100%",
                      background: submitted ? "#22C55E" : "linear-gradient(135deg, #D97A52 0%, #C1502E 55%, #8F3D22 100%)",
                      color: "#fff",
                      border: "none",
                      padding: "17px 28px",
                      borderRadius: 12,
                      ...
                      boxShadow: submitted ? "none" : "0 8px 26px rgba(193,80,46,.32), inset 0 1px 0 rgba(255,255,255,.18)",
                      fontFamily: "inherit",
                    }}
                    onMouseEnter={(e) => { if (!submitted) { e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 14px 42px rgba(193,80,46,.45), inset 0 1px 0 rgba(255,255,255,.25)"; } }}
                    onMouseLeave={(e) => { if (!submitted) { e.currentTarget.style.transform = "none"; e.currentTarget.style.boxShadow = "0 8px 26px rgba(193,80,46,.32), inset 0 1px 0 rgba(255,255,255,.18)"; } }}
                  >
                  ...
                  <p style={{ fontSize: 13, color: "#9CA3AF", marginTop: 16, textAlign: "center", lineHeight: 1.6 }}>
                    Prefer WhatsApp?{" "}
                    <a href="https://wa.me/919137130817" target="_blank" rel="noopener noreferrer" style={{ color: "#25D366", fontWeight: 600, textDecoration: "none" }}>
      ...
      {/* ── PROCESS STRIP ── */}
      <section style={{ background: "#141210", padding: "80px clamp(20px,5vw,80px)" }}>
      ...
      <section style={{ background: "#fff", padding: "100px clamp(20px,5vw,80px)" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div ref={ref4} style={{ textAlign: "center", marginBottom: 72, opacity: v4 ? 1 : 0, transition: "all .7s" }}>
            <h2 style={{ fontSize: "clamp(28px,3vw,44px)", fontWeight: 800, color: "#141210", letterSpacing: "-1px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {FAQS.map((faq, i) => (
                <div key={i} onClick={() => setActiveFAQ(i)}
                  style={{ padding: "18px 24px", borderRadius: 10, cursor: "pointer", transition: "all .25s", background: activeFAQ === i ? "#C1502E" : "#F7F7F5", border: `1px solid ${activeFAQ === i ? "#C1502E" : "#E4E3DD"}`, display: "flex", justifyContent: "space-between", alignItems: "center", gap: 16 }}
                  onMouseEnter={(e) => { if (activeFAQ !== i) { e.currentTarget.style.borderColor = "rgba(193,80,46,.4)"; e.currentTarget.style.background = "#fff5f3"; } }}
                  onMouseLeave={(e) => { if (activeFAQ !== i) { e.currentTarget.style.borderColor = "#E4E3DD"; e.currentTarget.style.background = "#F7F7F5"; } }}
                >
                  <span style={{ fontSize: 14, fontWeight: 600, color: activeFAQ === i ? "#fff" : "#141210", transition: "color .25s" }}>{faq.q}</span>
                  <span style={{ fontSize: 18, color: activeFAQ === i ? "#fff" : "#C1502E", flexShrink: 0, transition: "transform .3s", transform: activeFAQ === i ? "rotate(45deg)" : "none", fontWeight: 300 }}>+</span>
                </div>
              ))}
            </div>
            <div className="cw-unsticky-mobile" style={{ position: "sticky", top: 100 }}>
              <div key={activeFAQ} style={{ background: "#fff", borderRadius: 16, padding: "40px 36px", border: "1.5px solid #C1502E", boxShadow: "0 12px 48px rgba(193,80,46,.08)", animation: "faqIn .3s cubic-bezier(.16,1,.3,1)" }}>
                <div style={{ width: 40, height: 3, background: "#C1502E", borderRadius: 2, marginBottom: 20 }} />
                <h3 style={{ fontSize: 18, fontWeight: 700, color: "#141210", marginBottom: 14, lineHeight: 1.4 }}>{FAQS[activeFAQ].q}</h3>
      ...
      <section style={{ position: "relative", overflow: "hidden", minHeight: 580, display: "flex", alignItems: "center" }}>
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: 860, margin: "0 auto", padding: "100px clamp(20px,5vw,80px)", textAlign: "center", width: "100%" }}>
          ...
          <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
            <a href="https://wa.me/919137130817" target="_blank" rel="noopener noreferrer" className="cw-btn cw-btn-wa" style={{ textTransform: "none", letterSpacing: "0.03em" }}>
